...
[GlobalClass]
public partial class GOMonitor : GOTriggerable
{
    [Export]
    public AnimationPlayer animationPlayer { get; set; }
    public SubViewport ourViewPort { get; set; }

    public GOMonitor()
    {
        ourViewPort = (SubViewport)((PackedScene)GD.Load("res://scenes/ui/ingame/labelmonitor.tscn")).Instantiate();
    }
